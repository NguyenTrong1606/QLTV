#define BG_COLOR 						11
#define BG_EDITTEXT_COLOR				10
#define TEXT_TITLE_COLOR				4
#define TEXT_COLOR 						9
#define BORDER_COLOR 					4
#define TEXT_EDIITEXT_TITLE_COLOR 		4
#define TEXT_EDIITEXT_HINT_COLOR 		2
#define TEXT_EDITTEXT_COLOR				4
#define BG_BUTTON_DEFAULT 				6
#define BG_BUTTON_SELECT 				1
#define TEXT_BUTTON_SELECT 				15
#define TEXT_BUTTON_DEFAULT				11
#define LINE							14
#define TIPS 							1
